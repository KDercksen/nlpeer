...
from nlpeer.tasks import abstract_with_review_only, get_loss_function, get_optimizer
...
class LitTransformerRspModule(pl.LightningModule):
    ...
    def get_prepare_input(
        self, dataset_type: DATASETS
...
def from_config(config):
    ...
    if (
        ...
        return LitTransformerRspModule(
            model_type=mtype,
    ...
    # from disk
        ...
        return LitTransformerRspModule.load_from_checkpoint(
