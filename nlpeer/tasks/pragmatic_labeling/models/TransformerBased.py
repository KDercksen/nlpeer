...
from nlpeer.tasks import (
    get_class_map_pragmatics,
    get_loss_function,
    get_optimizer,
    review_sentence_no_context,
)
...
def from_config(config):
    ...
    if (
        ...
        return LitTransformerPragmaticLabelingModule(
            model_type=mtype,
    ...
    # from disk
        ...
        return LitTransformerPragmaticLabelingModule.load_from_checkpoint(
